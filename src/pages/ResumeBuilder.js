...
const ResumeBuilder = () => {
    return (
        ...
        >
            <Box sx={{ width: { md: "50%" }, mt: { xs: "30px", md: "" } }}>
                <Typography
                    variant="h2"
                    component="h2"
                    sx={{
                ...
                >
                    ...
                    >
                        Level up your resume with this professional resume
                        example. This resume sample will help you unleash the
                        full potential of your career.
                    </Typography>
                    <Button
                        variant="contained"
                        sx={{
