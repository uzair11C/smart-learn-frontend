...
const RoadmapResult = () => {
  ...
  return (
    ...
    >
      ...
      <Typography variant="h3" fontSize="7vmin" color="#FFFFFF">
        {searchTerm.charAt(0).toUpperCase() + searchTerm.slice(1)} Roadmap
      </Typography>
      {loading ? (
        ""
      ) : (
        <>
          ...
          <LearningResources roadmapJson={roadmapJson} roadmap={searchTerm} />
        </>
      )}
